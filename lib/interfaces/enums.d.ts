...
export declare const ProtectedRoutesPaths: {
    ...
    readonly manageParcels: 'all-qnrs/manage-parcels';
    readonly smsTemplates: 'all-qnrs/sms-templates';
    readonly anonymousForms: 'all-qnrs/anonymous-forms';
    readonly sendOrders: 'all-qnrs/send-orders';
    readonly anonymousQnrs: 'all-qnrs/anonymous-qnrs';
    ...
    readonly releasePackages: 'revman/release-packages';
...
export declare const SearchParams: {
    ...
    readonly SignUserId: 'sign_user_id';
    readonly SignActivityId: 'sign_activity_id';
