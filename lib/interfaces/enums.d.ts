...
export declare const ProtectedRoutesPaths: {
    ...
    readonly inboxOutbox: "research/inbox-outbox";
    readonly allQnrsAndFiles: "research/all-qnrs-and-files";
    readonly manageQnrs: "research/manage-qnrs";
    readonly manageParcels: "research/manage-parcels";
    readonly smsPainter: "research/sms-painter";
    readonly anonymousForms: "research/anonymous-forms";
    readonly sendOrders: "research/send-orders";
    readonly anonymousQnrs: "research/anonymous-qnrs";
