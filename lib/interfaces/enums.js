...
export const ProtectedRoutesPaths = {
    ...
    // The platform-default WORKSPACES context group page (AdvocaNavigationDestinationIds invariant:
    // every promotable destination id is a key here).
    workspaces: 'qnr-module/workspaces',
    allQnrs: 'all-qnrs',
    summary: 'summary',
