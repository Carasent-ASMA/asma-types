...
(function (QuestionTypes) {
    ...
    QuestionTypes["Title"] = "Title";
    QuestionTypes["NextPage"] = "NextPage";
...
export var TextShortTypes;
(function (TextShortTypes) {
    TextShortTypes["Ordinary"] = "ORDINARY";
    TextShortTypes["Email"] = "EMAIL";
})(TextShortTypes || (TextShortTypes = {}));
 ...
 */
export const getDocStatus = ({ for_signing, signicat_status }) => {
    if (!for_signing)
        return DocStatus.OnlyForView;
    if (signicat_status === DocSignicatSignStatusTypes.Completed)
        return DocStatus.Signed;
    if (signicat_status === DocSignicatSignStatusTypes.Rejected)
        return DocStatus.Rejected;
    return DocStatus.WaitingForSigning;
};
...
export const ProtectedRoutesPaths = {
    ...
    helpLinksCareGiverMenu: 'admin-panel/help-links/care-giver',
    helpLinksCareReceiverMenu: 'admin-panel/help-links/care-receiver',
    helpLinksAdvocaMenu: 'admin-panel/help-links/advoca',
...
export const SearchParams = {
    ...
    TaskId: 'taskId',
    Subdomain: 'subdomain',
    SelectedTherapistActno: 'selected_therapist_actno',
    code: 'code',
